...
def __createProfiles():
  ...
  profileManager.addAndUpdateProfile('D', '192.168.0.164', ['192.168.4.0/24'], 4003, ['A', 'B', 'E'])
  profileManager.addAndUpdateProfile('E', '192.168.0.164', ['192.168.6.0/24'], 4004, ['D', 'F'])
  profileManager.addAndUpdateProfile('F', '192.168.0.164', ['192.168.5.0/24'], 4005, ['C', 'E'])
