...
def __createProfiles():
  ...
  profileManager.addAndUpdateProfile('A', '192.168.0.114', ['192.168.1.0/24', '192.168.4.0/24'], 4000, ['B', 'D'])
  profileManager.addAndUpdateProfile('B', '192.168.0.114', ['192.168.2.0/24'], 4001, ['A', 'C', 'D'])
  profileManager.addAndUpdateProfile('C', '192.168.0.114', ['192.168.2.0/24', '192.168.3.0/24'], 4002, ['B', 'F'])
